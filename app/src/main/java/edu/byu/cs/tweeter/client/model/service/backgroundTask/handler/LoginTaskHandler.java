...
public class LoginTaskHandler extends Handler {
    ...
    private final AuthenticationObserver observer;

    public LoginTaskHandler(AuthenticationObserver observer) {
    ...
    public void handleMessage(Message message) {
        ...
        if (success) {
            ...
            observer.authenticationSucceeded(authToken, user);
            ...
            observer.handleExceptions(ex.getMessage());
        }
    }
}
